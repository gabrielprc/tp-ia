...
(defrule R24
	...
	(assert
		(Presuncion
			...
			(Probabilidad "Muy Alta")
			(Justificacion "Inflamacion o sangrado de encias junto con diabetes")
		)
	)
)
...
(defrule R26
	...
	(assert
		(Presuncion
			...
			(Probabilidad "Muy Alta")
			(Justificacion "Dolores al morder, exceso visible de placa y mal aliento en un paciente fumador u obeso")
		)
	)
)
